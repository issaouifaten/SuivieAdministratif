...
public class PortfeuilleClientTraiteTask extends AsyncTask<String, String, String> {
    ...
    public PortfeuilleClientTraiteTask(Activity activity, ListView lv_prtf_client, ProgressBar pb , String CodeClientSelected  ) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query_echeance_client = " select  NumeroReglementClient  ,  Echeance  , CodeTiers as CodeClient , Vue_CaisseRecette.RaisonSociale,  NumeroPiece,Reference , Solde as Montant ,\n" +
                        ...
                        "where  Vue_CaisseRecette.CodeModeReglement='T' \n" +
    ...
    protected void onPostExecute(String r) {
        ...
        PortfeuilleClientChequeAdapterLV   adapterLV  = new PortfeuilleClientChequeAdapterLV(activity  , listPrtfeilleClient ,"Traite") ;
        ...
        PortFeuilleTraiteActvity.txt_tot_portfeuille.setText(instance.format(tot_echeance));

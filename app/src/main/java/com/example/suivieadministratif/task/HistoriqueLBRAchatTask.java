...
public class  HistoriqueLBRAchatTask extends AsyncTask <String, String, String> {
    ...
    public HistoriqueLBRAchatTask(Activity activity , ListView lv_list_lbr , String NumeroBR , ProgressBar pb) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String queryClient = "  select \n" +
                        "NumeroBonRetourAchat  , CodeArticle  ,Quantite   , MontantTTC \n" +

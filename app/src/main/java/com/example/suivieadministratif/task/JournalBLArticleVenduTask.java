...
public class JournalBLArticleVenduTask extends AsyncTask<String, String, String> {
    ...
    public JournalBLArticleVenduTask(Activity activity, String date_debut, String date_fin , String  CodeClient  , ExpandableListView elv_jav, ProgressBar pb) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query_echeance_client = " select * from \n" +
                        ...
                        "from Vue_ListeVenteGlobal where DatePiece between '" + date_debut  + "' and '" +  date_fin + "' "+CONDITION+" ) as t  \n" +
    ...
    protected void onPostExecute(String r) {
      ...
      JournalBLVenteActivity.txt_total_ttc.setText(instance.format(tot_journal));

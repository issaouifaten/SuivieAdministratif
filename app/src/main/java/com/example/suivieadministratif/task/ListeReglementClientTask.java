...
public class ListeReglementClientTask extends AsyncTask<String, String, String> {
    ...
    public ListeReglementClientTask(Activity activity  , ListView lv_reglement_client , ProgressBar pb_chargement , Date  date_debut  , Date date_fin ) {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query = " select NumeroReglementClient ,DateReglement  , RaisonSociale,TotalPayement ,NomUtilisateur   \n" +
                ...
                while (rs.next()) {
                    ...
                    ReglementClient reglementClient  = new  ReglementClient (NumeroReglementClient ,DateReglement ,RaisonSociale ,TotalPayer ,NomUtilisateur ) ;

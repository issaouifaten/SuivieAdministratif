...
//btn_facture_achat
        ...
        CardView   btn_fiche_fournisseur = (CardView)   root.findViewById(R.id.btn_fiche_fournisseur);
        btn_fiche_fournisseur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Fragment fragment = new SelectFournisseurFragment();

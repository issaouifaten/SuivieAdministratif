...
import com.example.suivieadministratif.task.AlimentationCaisseTask;
...
public class AlimentationCaisseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " : Alimentation Caisse ");
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AlimentationCaisseActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void updateData() {
        ...
        new AlimentationCaisseTask(this, date_debut, date_fin, lv_list_reg_client, pb).execute();
    }
}
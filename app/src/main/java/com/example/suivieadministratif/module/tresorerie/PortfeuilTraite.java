...
public class PortfeuilTraite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " :Portfeuil Traite ");
            ...
            try {
                ...
                if (con == null) {
                    ...
                    String queryTable = "select DatePiece,NumeroPiece,Reference,Solde,Porteur," +
                            ...
                            " where  Vue_CaisseRecette.CodeModeReglement='T' and Vue_CaisseRecette.Libelle='Reception Regelement'\n" +

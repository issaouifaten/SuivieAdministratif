...
public class DetailLigneBonSortie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_ligne_bon_sortie);

        Intent intent=getIntent();
        //" NumeroBonSortie", "DateCreation",   "Depot","TotalTTC","Etat"
        NumeroBonSortie=intent.getStringExtra("NumeroBonSortie");
        ...
        Toast.makeText(getApplicationContext(),""+NumeroBonSortie,Toast.LENGTH_LONG).show();
        ...
        txt_num_bc.setText( ""+NumeroBonSortie);

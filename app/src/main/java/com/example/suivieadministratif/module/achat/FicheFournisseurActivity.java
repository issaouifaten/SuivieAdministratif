...
import com.example.suivieadministratif.task.FicheFournisseurTask;
...
public class FicheFournisseurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fiche_fournisseur);
        ...
        CodeFournisseur = getIntent().getStringExtra("CodeFournisseur") ;
        String  RaisonSociale = getIntent().getStringExtra("RaisonSociale") ;

        //sql session
        SharedPreferences pref = getSharedPreferences("usersessionsql", Context.MODE_PRIVATE);
        String NomSociete = pref.getString("NomSociete", "");
        setTitle(NomSociete + " : Fiche : "+RaisonSociale);
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(FicheFournisseurActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...

    {
        ...
        FicheFournisseurTask ficheArticlekParDepotParArticleTask = new FicheFournisseurTask(FicheFournisseurActivity.this, lv_list_fiche_article, CodeFournisseur, date_debut, date_fin, progressBar);

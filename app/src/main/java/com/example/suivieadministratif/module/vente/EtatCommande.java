...
public class EtatCommande extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListClientTaskForSearchSpinner listClientTaskForSearchableSpinner = new ListClientTaskForSearchSpinner(this ,sp_client, "EtatCommande") ;
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EtatCommande.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void updateData() {
        ...
        HistoriqueBCTask historiqueBCTask = new HistoriqueBCTask(this, date_debut, date_fin, lv_list_historique_bc, pb_bc, CodeClientSelected);

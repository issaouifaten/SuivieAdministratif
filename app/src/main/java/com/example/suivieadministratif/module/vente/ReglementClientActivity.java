...
public class ReglementClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " : Règlement Client") ;
        ...
        ListClientTaskForSearchSpinner listClientTaskForSearchableSpinner = new ListClientTaskForSearchSpinner(this ,sp_client, "ReglementClientActivity") ;
    ...
    public void updateData() {
        ...
        ListeReglementClientTask listeReglementClientTask = new ListeReglementClientTask(this, lv_list_reg_client, pb, date_debut, date_fin, CodeClientSelected);

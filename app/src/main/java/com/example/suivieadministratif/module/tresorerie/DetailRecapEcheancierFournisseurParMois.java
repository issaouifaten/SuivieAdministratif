...
public class DetailRecapEcheancierFournisseurParMois extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       ImageView img = findViewById(R.id.img) ;
        ...
        txt_mode_reg.setText("Fournisseur "+libelle_reglement);
        ...
        new DetailRecapEcheanceFournisseurParMoisTask  (this ,annee,mois,date_debut ,date_fin  , mode_reglement , lv_list ,pb ) .execute();

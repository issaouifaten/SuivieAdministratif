...
public class DetailLigneFactureVente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_ligne_facture_vente);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (con == null) {
                    ...
                    String queryTable = " select  CodeArticle,DesignationArticle, convert(numeric(18,0),Quantite)as Quantite ,MontantTTC  from LigneFactureVente where  NumeroFactureVente='"+ NumeroFactureVente+"' ";

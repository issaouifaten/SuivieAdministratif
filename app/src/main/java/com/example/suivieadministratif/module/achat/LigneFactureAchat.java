...
public class LigneFactureAchat extends AppCompatActivity {
   ...
   ProgressBar  progressBar  ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " : Détail Facture ");
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (con == null) {
                    ...
                    String queryTable = " select  CodeArticle,DesignationArticle, convert(numeric(18,0),Quantite)as Quantite , NetHT , TauxRemise  , MontantTTC    from LigneFactureAchat where  NumeroFactureAchat='"+ NumeroFactureAchat+"' ";

...
public class ReglementFournisseurActivity extends AppCompatActivity {
    ...
    public static ListView lv_list_reg_fournisseur  ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " : Règlement Fournisseur") ;
        txt_date_debut = findViewById(R.id.txt_date_debut);
        txt_date_fin = findViewById(R.id.txt_date_fin);

        lv_list_reg_fournisseur  = findViewById( R.id.lv_list) ;
        ...
        txt_libelle_ttc.setText("Total Règlement");
        ...
        ListFournisseurTaskForSearchableSpinner listFournisseurTaskForSearchableSpinner = new ListFournisseurTaskForSearchableSpinner(this , sp_fournisseur,"ReglementFournisseurActivity") ;
...
//btn_facture_achat
    ...
    public   void   updateData ()
    {
        ...
        ListeReglementFournisseurTask listeReglementFournisseurTask  = new ListeReglementFournisseurTask(this ,lv_list_reg_fournisseur , pb ,date_debut ,date_fin ,  CodeFournisseurSelected ) ;

...
public class DetailLigneFactureAchat extends AppCompatActivity {

    String  NumeroFactureAchat="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_ligne_facture_achat);

        Intent intent=getIntent();
        //" NumeroFactureAchat", "DateCreation",   "RaisonSociale","TotalTTC","Etat"
        NumeroFactureAchat=intent.getStringExtra("NumeroFactureAchat");
        ...
        Toast.makeText(getApplicationContext(),""+NumeroFactureAchat,Toast.LENGTH_LONG).show();
        ...
        txt_num_bc.setText( ""+NumeroFactureAchat);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (con == null) {
                    ...
                    String queryTable = " select  CodeArticle,DesignationArticle, convert(numeric(18,0),Quantite)as Quantite ,MontantTTC  from LigneFactureAchat where  NumeroFactureAchat='"+ NumeroFactureAchat+"' ";

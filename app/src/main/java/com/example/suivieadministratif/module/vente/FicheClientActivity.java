...
import com.example.suivieadministratif.task.FicheClientTask;
...
public class FicheClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fiche_client2);
        ...
        TypeFiche= getIntent().getStringExtra("TypeFiche") ;

        //sql session
        SharedPreferences pref = getSharedPreferences("usersessionsql", Context.MODE_PRIVATE);
        String NomSociete = pref.getString("NomSociete", "");
        setTitle(NomSociete + " : Fiche "+TypeFiche +" : "+RaisonSociale);
        ...
        rv_list_fiche = (RecyclerView) findViewById(R.id.lv_list);

        rv_list_fiche.setHasFixedSize(true);
        rv_list_fiche.setLayoutManager(new LinearLayoutManager(this));
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(FicheClientActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override

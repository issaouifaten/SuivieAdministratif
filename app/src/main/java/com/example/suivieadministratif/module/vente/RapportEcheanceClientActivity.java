...
public class RapportEcheanceClientActivity extends AppCompatActivity {
    ...
    public static ListView lv_list_echeance_client;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " : Rapport Echéance Client") ;

        txt_date_debut = findViewById(R.id.txt_date_debut);
        txt_date_fin = findViewById(R.id.txt_date_fin);

        lv_list_echeance_client = findViewById(R.id.lv_list);
        ...
        txt_tot_echeance = (TextView) findViewById(R.id.txt_total_ttc);
        ...
        ListClientTaskForSearchSpinner listClientTaskForSearchableSpinner = new ListClientTaskForSearchSpinner(this ,sp_client, "RapportEcheanceClientActivity") ;
    ...
    public void updateData() {
        ...
        EcheanceClientTask echeanceClientTask = new EcheanceClientTask(this, date_debut, date_fin, lv_list_echeance_client, pb, CodeClientSelected);

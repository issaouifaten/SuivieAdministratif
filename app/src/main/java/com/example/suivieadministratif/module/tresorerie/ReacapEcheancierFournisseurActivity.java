...
import com.example.suivieadministratif.task.ListeRecapEcheanceFournisseurTask;

public class ReacapEcheancierFournisseurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_mode_reg.setText(" Fournisseur - "+ModeRegSeleted);
      ...
      new ListeRecapEcheanceFournisseurTask(this, date_debut, date_fin, CodeModeRegSeleted,ModeRegSeleted , lvlist_recap, pb).execute();

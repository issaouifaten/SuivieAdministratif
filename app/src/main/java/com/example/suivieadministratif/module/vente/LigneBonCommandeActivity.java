...
public class LigneBonCommandeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_num_bc = (TextView) findViewById(R.id.txt_num_piece);
        ...
        lv_ligne_bc = (ListView) findViewById(R.id.lv_ligne_piece);

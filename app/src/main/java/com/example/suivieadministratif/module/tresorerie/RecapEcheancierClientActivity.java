...
public class RecapEcheancierClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_mode_reg.setText(" Client - "+ModeRegSeleted);
        ...
        new ListeRecapEcheanceClientTask(this, date_debut, date_fin, CodeModeRegSeleted,ModeRegSeleted , lvlist_recap, pb).execute();

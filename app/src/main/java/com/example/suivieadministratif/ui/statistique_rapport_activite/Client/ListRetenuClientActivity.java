...
public class ListRetenuClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(NomSociete + " : Liste Retenu Client");
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ListRetenuClientActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public   void updateData()
    {
        ...
        ListeRetenuClientTask listeRetenuClientTask   = new ListeRetenuClientTask(this , date_debut ,date_fin , lv_list , pb_bc  ,search_bar_client) ;
        listeRetenuClientTask.execute() ;
    }

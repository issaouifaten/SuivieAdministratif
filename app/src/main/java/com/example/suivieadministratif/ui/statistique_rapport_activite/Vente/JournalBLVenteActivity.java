...
public class JournalBLVenteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_journal_b_l_vente);


        SharedPreferences pref = getSharedPreferences("usersessionsql", Context.MODE_PRIVATE);
        String NomSociete = pref.getString("NomSociete", "");
        setTitle(NomSociete + " : Journal BL Vente");
        ...
        new JournalBLArticleVenduTask(this, _date_debut, _date_fin, _code_client, elv_jav, pb).execute();
